Big City Games and Techland Software present Bridge 3000
...
CONTENTS
      ...
      II: INSTALLATION
      III:CUSTOMER AND TECHNICAL SUPPORT INFORMATION 
...
In order to install the game You should insert the Bridge 3000 CD into the CD-ROM drive. 
The installation program will start automatically after a moment. If this does not happen you should 
execute the Setup.exe file from the CD-ROM.

Available options:

INSTALL - installs the game on Your computer.
EXIT - the installation program . 
README - a readme information file will be open.
TECHLAND WEBSITE - automatically displays Techland's web page.
BIG CITY GAMES WEBSITE - automatically displays Big City Games website
...
contact our technical support staff. Before you contact tech support, please read this README.TXT file on 
the bridge 3000 CD to see any last minute recommendations pertinent to your problem. 
Also, check out the Support page on our web site listed below. 

Please, make sure that before contacting our Customer Support representatives You have 
the following information:

- Product title 
- Computer's processor type and speed
- Amount of RAM
- Make and model of your video and sound card
- Make and model of your CD-ROM or DVD-ROM drive
- Operating System

Big City Games web site: http://www.bigcitygames.com
Bridge 3000 official web site: http://www.techland.com.pl/enIndex.php

Internet e-mail: For technical support questions or concerns, please fill out our online form at 
http://www.bigcitygames.com/en/support or contact us at support@bigcitygames.com 

Please, make sure that before contacting our Customer Support representatives You have following information:
...
License Agreement for Bridge 3000

PLEASE READ THIS LICENSE CAREFULLY BEFORE USING THE SOFTWARE. THIS DOCUMENT IS AN AGREEMENT BETWEEN YOU AND BIG CITY GAMES (THE "COMPANY"). THE COMPANY IS WILLING TO LICENSE THE ENCLOSED SOFTWARE TO YOU ONLY ON THE CONDITION THAT YOU ACCEPT ALL THE TERMS CONTAINED IN THIS AGREEMENT. BY USING THE SOFTWARE YOU ARE AGREEING TO BE BOUND BY THE TERMS OF THIS LICENSE.
...
5. Copyright Notice. The Company and/or our Licensors hold valid copyright of the Software. Nothing in this Agreement constitutes a waiver of any right under Canadian Copyright law or any other federal or provincial law. This program is protected by Canadian federal and international copyright laws.
